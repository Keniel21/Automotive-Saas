-- ==========================================================================
-- AUTO DRIVE CRM - BANCO DE DADOS POSTGRESQL (SUPABASE CONFIG)
...
INSERT INTO estoque (id, model, year, km, buy_price, sell_price, days_in_stock, status, type) VALUES
(1, 'Jeep Compass Longitude 2.0 Flex', '2021/2021', 42000, 110000.00, 125900.00, 45, 'disponivel', 'convencional'),
(2, 'Toyota Corolla XEi 2.0 Flex', '2020/2020', 58000, 95000.00, 108500.00, 12, 'reservado', 'convencional'),
(3, 'Honda Civic EXL 2.0', '2019/2019', 64000, 88000.00, 99900.00, 35, 'disponivel', 'convencional'),
(4, 'VW Polo Comfortline 1.0 TSI', '2022/2023', 28000, 72000.00, 81900.00, 8, 'preparacao', 'convencional'),
(5, 'Chevrolet Onix Plus LTZ Turbo', '2021/2021', 38000, 65000.00, 71000.00, 52, 'disponivel', 'repasse'),
(6, 'Hyundai HB20 Evolution 1.0', '2020/2021', 49000, 53000.00, 58500.00, 22, 'disponivel', 'repasse'),
(7, 'Ford Ka SE 1.0', '2019/2019', 75000, 38000.00, 42000.00, 4, 'vendido', 'repasse');
